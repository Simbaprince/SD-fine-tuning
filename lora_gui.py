...
def save_configuration(
    ...
    if file_path == None or file_path == '':
        # In case a file_path was provided and the user decide to cancel the open action
    ...
    SaveConfigFile(parameters=parameters, file_path=file_path,
...
def open_configuration(
    ...
    if not file_path == '' and not file_path == None:
        ...
        # In case a file_path was provided and the user decides to cancel the open action
...
def train_model(
    ...
    if print_only_bool:
        ...
        SaveConfigFile(parameters=parameters, file_path=file_path, exclusion=[
                       'file_path', 'save_as', 'headless', 'print_only'])
...
def lora_tab(
    ...
    with gr.Tab('Training'):
        ...
        training_preset.input(
            ...
            + settings_list
            + [training_preset],
            outputs=[gr.Textbox()] + settings_list +
            [training_preset, LoCon_row],
            show_progress=False,
        )
